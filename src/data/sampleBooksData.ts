...
export const RAW_SAMPLE_BOOKS = [
  ...
  },
  {
    ...
    "isbn10": "0143110438",
    "coverUrl": "https://covers.openlibrary.org/b/isbn/9780143110439-L.jpg",
    "pageCount": 462,
    "publishedDate": "2016",
    "genres": ["Fiction", "Historical Fiction"],
  ...
  },
  {
    ...
    "author": "Bill Bryson",
    "isbn13": "9780385539302",
    "isbn10": "0385539304",
    "coverUrl": "https://covers.openlibrary.org/b/isbn/9780385539302-L.jpg",
    "pageCount": 464,
    "publishedDate": "2019",
  ...
  },
  {
    ...
    "isbn10": null,
    "coverUrl": "https://covers.openlibrary.org/b/isbn/9780385521314-L.jpg",
    "pageCount": null,
    "publishedDate": "2019",
  ...
  },
  {
    ...
    "isbn10": "0316452505",
    "coverUrl": "https://covers.openlibrary.org/b/isbn/9780316452502-L.jpg",
    "pageCount": 600,
    "publishedDate": "2015",
    "genres": ["Sci-Fi & Fantasy", "Science Fiction"],
    "description": "The last remnants of the human race left a dying Earth, desperate to find a new home among the stars. Following in the footsteps of their ancestors, they discover the greatest treasure of the past age — a world terraformed and ready for human life.",
    "publisher": "Orbit"
  },
  {
  ...
  },
  {
    ...
    "isbn10": "031624662X",
    "coverUrl": "https://covers.openlibrary.org/b/isbn/9780316246620-L.jpg",
    "pageCount": 386,
    "publishedDate": "2013",
    "genres": ["Sci-Fi & Fantasy", "Science Fiction"],
    "description": "On a remote, icy planet, the soldier known as Breq is drawing closer to completing her quest. Once, she was the Justice of Toren — a colossal starship with an artificial intelligence linking thousands of soldiers in the service of the Radch.",
    "publisher": "Orbit"
  },
  {
    "title": "Deep Work",
  ...
  },
  {
    ...
    "description": "Ryan Holiday shows us how some of the most successful people in history — from John D. Rockefeller to Amelia Earhart — have applied Stoicism to overcome difficult or even impossible situations.",
    "publisher": "Portfolio"
  },
  {
...
export function getCuratedInitialBooks(): Book[] {
  ...
  return RAW_SAMPLE_BOOKS.map((raw, index) => {
    ...
    return {
      ...
      title: raw.title,
      author: raw.author,
      additionalAuthors: (raw as any).additionalAuthors,
      isbn13: raw.isbn13,
      isbn10: raw.isbn10,
